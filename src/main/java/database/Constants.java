...
public class Constants {
    public static Map<String, List<String>> getRolesRights(){
        ...
        rolesRights.get(ADMINISTRATOR).addAll(Arrays.asList(Rights.RIGHTS));
    ...
    public static class Tables{
        ...
        public static final String[] ORDERED_TABLES_FOR_CREATION =
                new String[]{USER, ROLE, RIGHT, ROLE_RIGHT, USER_ROLE, BOOK, ORDER};
    }
    ...
    public static class Rights {
        ...
        public static final String[] RIGHTS = new String[]{
                CREATE_USER, DELETE_USER, UPDATE_USER, CREATE_BOOK, DELETE_BOOK, UPDATE_BOOK,
